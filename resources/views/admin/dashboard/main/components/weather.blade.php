                    ...
                    <div class="city-selected body l-salmon">
                        <div class="row">
                            ...
                            <div class="icon col-5">
                                <img src="{{asset('asset-admin/images/weather/summer.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="carousel-item text-center active">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Monday</p>
                                            <img src="{{asset('asset-admin/images/weather/rain.svg')}}" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Tuesday</p>
                                            <img src="{{asset('asset-admin/images/weather/cloudy.svg')}}" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Wednesday</p>
                                            <img src="{{asset('asset-admin/images/weather/wind.svg')}}" alt="">
                                        </li>
                                    </ul>
                                </div>                                
                            </div>
                            <div class="carousel-item text-center">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Thursday</p>
                                            <img src="{{asset('asset-admin/images/weather/sky.svg')}}" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Friday</p>
                                            <img src="{{asset('asset-admin/images/weather/cloudy.svg')}}" alt="">
