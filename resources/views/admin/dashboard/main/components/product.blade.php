                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('asset-admin/images/xs/avatar1.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('asset-admin/images/xs/avatar2.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('asset-admin/images/xs/avatar10.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('asset-admin/images/xs/avatar4.jpg')}}" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="{{asset('asset-admin/images/xs/avatar5.jpg')}}" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td class="hidden-md-down">
                                            <ul class="list-unstyled team-info  margin-0">                                               
                                                ...
                                                <li>
                                                    <img src="{{asset('asset-admin/images/xs/avatar1.jpg')}}" alt="Avatar">
                                                </li>
                                                <li>
                                                    <img src="{{asset('asset-admin/images/xs/avatar2.jpg')}}" alt="Avatar">
                                                </li>                            
