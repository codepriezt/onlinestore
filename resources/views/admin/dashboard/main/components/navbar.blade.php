...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('asset-admin/images/logo.svg')}}" width="48" height="48" alt="Compass"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<nav class="navbar">
    <div class="col-12">        
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html"><img src="{{asset('asset-admin/images/logo.svg')}}" width="30" alt="Compass"><span class="m-l-10">Compass</span></a>
        </div>
