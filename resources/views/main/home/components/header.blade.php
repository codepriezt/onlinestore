                                ...
                                <div class="dropdownmenu-wrapper">
                                    ...
                                    <div class="dropdown-cart-products">
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="{{asset('asset/images/products/cart/product-2.jpg')}}" alt="product">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                ...
                <div class="container">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            <li
                               class="{{(strpos(Route::currentRouteName() , 'category_default') === 0)? 'active' : ''}} sf-with-ul"><a href="{{route('category_default')}}">Categories</a>
                                ...
                                <div class="megamenu">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="banner">
                                                <a href="#">
                                                    <img src="{{asset('asset/images/menu-banner.jpg')}}" alt="Menu banner" class="product-promo">
                                                </a>
                                            </div><!-- End .banner -->
                                        </div><!-- End .col-lg-4 -->
                                    </div><!-- End .row -->
