                ...
                <div class="home-slider-container">
                    <div class="home-slider owl-carousel owl-theme owl-theme-light">
                        <div class="home-slide">
                            <div class="slide-bg owl-lazy" data-src="{{asset('asset/images/slider/slide-1.jpg')}}"></div><!-- End .slide-bg -->
                        ...
                        <div class="home-slide home-slide-left">
                            <div class="slide-bg owl-lazy" data-src="{{asset('asset/images/slider/slide-2.jpg')}}"></div><!-- End .slide-bg -->
